...
namespace Narcosis101.DAL
{
    public class ItemInitializer : DropCreateDatabaseIfModelChanges<ItemContext>
    {
        protected override void Seed(ItemContext context)
        {
            ...
            {
            new Camera{ID=00001,Class = "c",Make="Nikonos",Model="test 1"},
            new Camera{ID=00002,Class = "c",Make="Nikonos",Model="test 2"},
            new Camera{ID=00003,Class = "c",Make="Nikonos",Model="test 3"}
           };
